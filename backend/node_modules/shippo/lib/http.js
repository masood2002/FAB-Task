...
class ResponseMatcher {
    ...
    options) {
        ...
        if (pred == null) {
            ...
            throw new sdkerror_js_1.SDKError("Unexpected API response status or content-type", response, responseBody);
        }
        ...
        let data;
        if (pred.fail) {
            throw new sdkerror_js_1.SDKError("API error occurred", response, typeof raw === "string" ? raw : "");
        }
        else if (pred.err) {
            data = {
        ...
        const body = (0, schemas_js_1.parse)(data, (v) => parser.parse(v), "Response validation failed");
