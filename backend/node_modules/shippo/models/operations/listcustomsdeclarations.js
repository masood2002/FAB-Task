...
exports.ListCustomsDeclarationsRequest$ = exports.ListCustomsDeclarationsGlobals$ = void 0;
const primitives_js_1 = require("../../lib/primitives.js");
const z = __importStar(require("zod"));
/** @internal */
var ListCustomsDeclarationsGlobals$;
(function (ListCustomsDeclarationsGlobals$) {
    ListCustomsDeclarationsGlobals$.inboundSchema = z
        .object({
    ...
    ListCustomsDeclarationsGlobals$.outboundSchema = z
        .object({
...
(function (ListCustomsDeclarationsRequest$) {
    ListCustomsDeclarationsRequest$.inboundSchema = z.object({
        page: z.number().int().default(1),
        results: z.number().int().default(5),
    });
    ListCustomsDeclarationsRequest$.outboundSchema = z.object({
        page: z.number().int().default(1),
        results: z.number().int().default(5),
    });
