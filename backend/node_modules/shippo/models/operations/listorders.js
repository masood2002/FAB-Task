...
exports.ListOrdersRequest$ = exports.ListOrdersGlobals$ = void 0;
...
(function (ListOrdersGlobals$) {
    ListOrdersGlobals$.inboundSchema = z
        .object({
    ...
    ListOrdersGlobals$.outboundSchema = z
        .object({
...
(function (ListOrdersRequest$) {
    ListOrdersRequest$.inboundSchema = z
        .object({
    ...
    ListOrdersRequest$.outboundSchema = z
        .object({
        page: z.number().int().default(1),
        results: z.number().int().default(25),
