...
exports.ListTransactionsRequest$ = exports.ListTransactionsGlobals$ = void 0;
...
(function (ListTransactionsGlobals$) {
    ListTransactionsGlobals$.inboundSchema = z
        .object({
    ...
    ListTransactionsGlobals$.outboundSchema = z
        .object({
...
(function (ListTransactionsRequest$) {
    ListTransactionsRequest$.inboundSchema = z
        .object({
    ...
    ListTransactionsRequest$.outboundSchema = z
        .object({
        rate: z.string().optional(),
