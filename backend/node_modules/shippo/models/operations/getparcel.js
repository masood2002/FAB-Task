...
exports.GetParcelRequest$ = exports.GetParcelGlobals$ = void 0;
const primitives_js_1 = require("../../lib/primitives.js");
const z = __importStar(require("zod"));
/** @internal */
var GetParcelGlobals$;
(function (GetParcelGlobals$) {
    GetParcelGlobals$.inboundSchema = z
        .object({
    ...
    GetParcelGlobals$.outboundSchema = z
        .object({
...
(function (GetParcelRequest$) {
    GetParcelRequest$.inboundSchema = z
        .object({
        ParcelId: z.string(),
    })
        .transform((v) => {
    ...
    GetParcelRequest$.outboundSchema = z
        .object({
        parcelId: z.string(),
    })
        .transform((v) => {
