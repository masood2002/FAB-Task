...
exports.GetShipmentRequest$ = exports.GetShipmentGlobals$ = void 0;
const primitives_js_1 = require("../../lib/primitives.js");
const z = __importStar(require("zod"));
/** @internal */
var GetShipmentGlobals$;
(function (GetShipmentGlobals$) {
    GetShipmentGlobals$.inboundSchema = z
        .object({
    ...
    GetShipmentGlobals$.outboundSchema = z
        .object({
...
(function (GetShipmentRequest$) {
    GetShipmentRequest$.inboundSchema = z
        .object({
        ShipmentId: z.string(),
    })
        .transform((v) => {
    ...
    GetShipmentRequest$.outboundSchema = z
        .object({
        shipmentId: z.string(),
    })
        .transform((v) => {
