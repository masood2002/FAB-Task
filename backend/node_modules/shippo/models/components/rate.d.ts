...
export declare namespace Attributes$ {
    const inboundSchema: z.ZodNativeEnum<typeof Attributes>;
    const outboundSchema: z.ZodNativeEnum<typeof Attributes>;
}
/** @internal */
export declare namespace Rate$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Rate>;
}
