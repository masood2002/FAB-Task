...
export declare namespace CreatedBy$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreatedBy>;
}
/** @internal */
export declare namespace TransactionRate$ {
    const inboundSchema: z.ZodType<TransactionRate, z.ZodTypeDef, unknown>;
    type Outbound = CoreRate$.Outbound | string;
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, TransactionRate>;
}
/** @internal */
