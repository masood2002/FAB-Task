...
import { BatchShipmentPaginatedList, BatchShipmentPaginatedList$ } from "./batchshipmentpaginatedlist.js";
...
export declare namespace ObjectResults$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ObjectResults>;
}
/** @internal */
export declare namespace BatchStatus$ {
    const inboundSchema: z.ZodNativeEnum<typeof BatchStatus>;
    const outboundSchema: z.ZodNativeEnum<typeof BatchStatus>;
}
/** @internal */
export declare namespace Batch$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Batch>;
}
