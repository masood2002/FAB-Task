...
/** @internal */
export declare namespace ParentServicelevel$ {
    const inboundSchema: z.ZodType<ParentServicelevel, z.ZodTypeDef, unknown>;
    type Outbound = {
        name?: string | undefined;
        terms?: string | undefined;
        token?: string | undefined;
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ParentServicelevel>;
}
/** @internal */
export declare namespace ServiceLevelWithParent$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ServiceLevelWithParent>;
}
