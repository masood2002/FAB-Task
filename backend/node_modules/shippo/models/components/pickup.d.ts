...
export declare namespace PickupStatus$ {
    const inboundSchema: z.ZodNativeEnum<typeof PickupStatus>;
    const outboundSchema: z.ZodNativeEnum<typeof PickupStatus>;
}
/** @internal */
export declare namespace Pickup$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Pickup>;
}
