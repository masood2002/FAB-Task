...
export declare namespace ObjectState$ {
    const inboundSchema: z.ZodNativeEnum<typeof ObjectState>;
    const outboundSchema: z.ZodNativeEnum<typeof ObjectState>;
}
/** @internal */
export declare namespace Parcel$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Parcel>;
}
