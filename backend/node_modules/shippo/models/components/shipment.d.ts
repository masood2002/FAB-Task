...
export declare namespace ShipmentStatus$ {
    const inboundSchema: z.ZodNativeEnum<typeof ShipmentStatus>;
    const outboundSchema: z.ZodNativeEnum<typeof ShipmentStatus>;
}
/** @internal */
export declare namespace Shipment$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Shipment>;
}
