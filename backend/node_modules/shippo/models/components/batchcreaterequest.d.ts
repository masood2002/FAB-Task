import { BatchShipmentCreateRequest, BatchShipmentCreateRequest$ } from "./batchshipmentcreaterequest.js";
...
export declare namespace BatchCreateRequest$ {
    ...
    const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BatchCreateRequest>;
}
