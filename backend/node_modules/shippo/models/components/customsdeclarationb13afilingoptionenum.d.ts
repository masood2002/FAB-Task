...
export declare namespace CustomsDeclarationB13AFilingOptionEnum$ {
    const inboundSchema: z.ZodNativeEnum<typeof CustomsDeclarationB13AFilingOptionEnum>;
    const outboundSchema: z.ZodNativeEnum<typeof CustomsDeclarationB13AFilingOptionEnum>;
}
