...
exports.ParcelTemplateEnumSet$ = exports.FedExParcelTemplate$ = exports.UPSParcelTemplate$ = exports.USPSParcelTemplate$ = exports.DHLECommerceParcelTemplate$ = exports.DPDUKParcelTemplate$ = exports.CouriersPleaseParcelTemplate$ = exports.AramexAustraliaParcelTemplate$ = exports.FedExParcelTemplate = exports.UPSParcelTemplate = exports.USPSParcelTemplate = exports.DHLECommerceParcelTemplate = exports.DPDUKParcelTemplate = exports.CouriersPleaseParcelTemplate = exports.AramexAustraliaParcelTemplate = void 0;
 ...
 *
 */
exports.AramexAustraliaParcelTemplate = {
 ...
 *
 */
exports.CouriersPleaseParcelTemplate = {
 ...
 *
 */
exports.DHLECommerceParcelTemplate = {
...
/** @internal */
var AramexAustraliaParcelTemplate$;
(function (AramexAustraliaParcelTemplate$) {
    AramexAustraliaParcelTemplate$.inboundSchema = z.nativeEnum(exports.AramexAustraliaParcelTemplate);
    AramexAustraliaParcelTemplate$.outboundSchema = AramexAustraliaParcelTemplate$.inboundSchema;
})(AramexAustraliaParcelTemplate$ || (exports.AramexAustraliaParcelTemplate$ = AramexAustraliaParcelTemplate$ = {}));
/** @internal */
var CouriersPleaseParcelTemplate$;
(function (CouriersPleaseParcelTemplate$) {
    CouriersPleaseParcelTemplate$.inboundSchema = z.nativeEnum(exports.CouriersPleaseParcelTemplate);
    CouriersPleaseParcelTemplate$.outboundSchema = CouriersPleaseParcelTemplate$.inboundSchema;
})(CouriersPleaseParcelTemplate$ || (exports.CouriersPleaseParcelTemplate$ = CouriersPleaseParcelTemplate$ = {}));
/** @internal */
var DPDUKParcelTemplate$;
(function (DPDUKParcelTemplate$) {
    DPDUKParcelTemplate$.inboundSchema = z.nativeEnum(exports.DPDUKParcelTemplate);
    DPDUKParcelTemplate$.outboundSchema = DPDUKParcelTemplate$.inboundSchema;
})(DPDUKParcelTemplate$ || (exports.DPDUKParcelTemplate$ = DPDUKParcelTemplate$ = {}));
/** @internal */
var DHLECommerceParcelTemplate$;
(function (DHLECommerceParcelTemplate$) {
    DHLECommerceParcelTemplate$.inboundSchema = z.nativeEnum(exports.DHLECommerceParcelTemplate);
    DHLECommerceParcelTemplate$.outboundSchema = DHLECommerceParcelTemplate$.inboundSchema;
})(DHLECommerceParcelTemplate$ || (exports.DHLECommerceParcelTemplate$ = DHLECommerceParcelTemplate$ = {}));
/** @internal */
var USPSParcelTemplate$;
(function (USPSParcelTemplate$) {
    USPSParcelTemplate$.inboundSchema = z.nativeEnum(exports.USPSParcelTemplate);
    USPSParcelTemplate$.outboundSchema = USPSParcelTemplate$.inboundSchema;
})(USPSParcelTemplate$ || (exports.USPSParcelTemplate$ = USPSParcelTemplate$ = {}));
/** @internal */
var UPSParcelTemplate$;
(function (UPSParcelTemplate$) {
    UPSParcelTemplate$.inboundSchema = z.nativeEnum(exports.UPSParcelTemplate);
    UPSParcelTemplate$.outboundSchema = UPSParcelTemplate$.inboundSchema;
})(UPSParcelTemplate$ || (exports.UPSParcelTemplate$ = UPSParcelTemplate$ = {}));
/** @internal */
var FedExParcelTemplate$;
(function (FedExParcelTemplate$) {
    FedExParcelTemplate$.inboundSchema = z.nativeEnum(exports.FedExParcelTemplate);
    FedExParcelTemplate$.outboundSchema = FedExParcelTemplate$.inboundSchema;
})(FedExParcelTemplate$ || (exports.FedExParcelTemplate$ = FedExParcelTemplate$ = {}));
/** @internal */
var ParcelTemplateEnumSet$;
(function (ParcelTemplateEnumSet$) {
    ParcelTemplateEnumSet$.inboundSchema = z.union([
    ...
    ParcelTemplateEnumSet$.outboundSchema = z.union([
...
})(ParcelTemplateEnumSet$ || (exports.ParcelTemplateEnumSet$ = ParcelTemplateEnumSet$ = {}));
//# sourceMappingURL=parceltemplateenumset.js.map