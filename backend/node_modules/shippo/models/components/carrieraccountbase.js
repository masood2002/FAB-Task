...
exports.CarrierAccountBase$ = exports.CarrierAccountBaseParameters$ = void 0;
...
(function (CarrierAccountBaseParameters$) {
    CarrierAccountBaseParameters$.inboundSchema = z.union([
    ...
    CarrierAccountBaseParameters$.outboundSchema = z.union([
...
(function (CarrierAccountBase$) {
    CarrierAccountBase$.inboundSchema = z
        .object({
        account_id: z.string(),
    ...
    CarrierAccountBase$.outboundSchema = z
        .object({
        accountId: z.string(),
        active: z.boolean().optional(),
        carrier: z.string(),
