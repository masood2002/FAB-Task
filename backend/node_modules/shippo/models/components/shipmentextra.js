...
exports.ShipmentExtra$ = exports.SignatureConfirmation$ = exports.ReturnServiceType$ = exports.PreferredDeliveryTimeframe$ = exports.DangerousGoodsCode$ = exports.AncillaryEndorsement$ = exports.SignatureConfirmation = exports.PreferredDeliveryTimeframe = exports.DangerousGoodsCode = exports.AncillaryEndorsement = void 0;
...
(function (AncillaryEndorsement$) {
    AncillaryEndorsement$.inboundSchema = z.nativeEnum(exports.AncillaryEndorsement);
    AncillaryEndorsement$.outboundSchema = AncillaryEndorsement$.inboundSchema;
})(AncillaryEndorsement$ || (exports.AncillaryEndorsement$ = AncillaryEndorsement$ = {}));
/** @internal */
var DangerousGoodsCode$;
(function (DangerousGoodsCode$) {
    DangerousGoodsCode$.inboundSchema = z.nativeEnum(exports.DangerousGoodsCode);
    DangerousGoodsCode$.outboundSchema = DangerousGoodsCode$.inboundSchema;
...
(function (PreferredDeliveryTimeframe$) {
    PreferredDeliveryTimeframe$.inboundSchema = z.nativeEnum(exports.PreferredDeliveryTimeframe);
    PreferredDeliveryTimeframe$.outboundSchema = PreferredDeliveryTimeframe$.inboundSchema;
...
(function (ReturnServiceType$) {
    ReturnServiceType$.inboundSchema = z.union([
    ...
    ReturnServiceType$.outboundSchema = z.union([
...
(function (SignatureConfirmation$) {
    SignatureConfirmation$.inboundSchema = z.nativeEnum(exports.SignatureConfirmation);
    SignatureConfirmation$.outboundSchema = SignatureConfirmation$.inboundSchema;
})(SignatureConfirmation$ || (exports.SignatureConfirmation$ = SignatureConfirmation$ = {}));
/** @internal */
var ShipmentExtra$;
(function (ShipmentExtra$) {
    ShipmentExtra$.inboundSchema = z
        .object({
        accounts_receivable_customer_account: upsreferencefields_js_1.UPSReferenceFields$.inboundSchema.optional(),
        ...
        lasership_attrs: z
            .array(shipmentextralasershipattributesenum_js_1.ShipmentExtraLasershipAttributesEnum$.inboundSchema)
            .optional(),
    ...
    ShipmentExtra$.outboundSchema = z
        .object({
        accountsReceivableCustomerAccount: upsreferencefields_js_1.UPSReferenceFields$.outboundSchema.optional(),
        ...
        lasershipAttrs: z
            .array(shipmentextralasershipattributesenum_js_1.ShipmentExtraLasershipAttributesEnum$.outboundSchema)
            .optional(),
