...
class Manifests extends sdks_js_1.ClientSDK {
    constructor(options = {}) {
        const opt = options;
        let hooks;
    ...
    async list(page, results, options) {
        ...
        const payload$ = schemas$.parse(input$, (value$) => operations.ListManifestsRequest$.outboundSchema.parse(value$), "Input validation failed");
        const body$ = null;
    ...
    async create(request, options) {
        const input$ = request;
        const payload$ = schemas$.parse(input$, (value$) => components.ManifestCreateRequest$.outboundSchema.parse(value$), "Input validation failed");
     ...
     */
    async get(manifestId, options) {
        const input$ = {
            manifestId: manifestId,
        };
        const payload$ = schemas$.parse(input$, (value$) => operations.GetManifestRequest$.outboundSchema.parse(value$), "Input validation failed");
        const body$ = null;
        const pathParams$ = {
