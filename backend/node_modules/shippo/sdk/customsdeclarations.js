...
class CustomsDeclarations extends sdks_js_1.ClientSDK {
    ...
    async list(page, results, options) {
        ...
        const payload$ = schemas$.parse(input$, (value$) => operations.ListCustomsDeclarationsRequest$.outboundSchema.parse(value$), "Input validation failed");
        const body$ = null;
    ...
    async create(request, options) {
        const input$ = request;
        const payload$ = schemas$.parse(input$, (value$) => components.CustomsDeclarationCreateRequest$.outboundSchema.parse(value$), "Input validation failed");
    ...
    async get(customsDeclarationId, page, options) {
        ...
        const payload$ = schemas$.parse(input$, (value$) => operations.GetCustomsDeclarationRequest$.outboundSchema.parse(value$), "Input validation failed");
        const body$ = null;
        const pathParams$ = {
        ...
        const path$ = this.templateURLComponent("/customs/declarations/{CustomsDeclarationId}")(pathParams$);
        const query$ = (0, encodings_js_1.encodeFormQuery)({
            page: payload$.page,
        });
        const headers$ = new Headers({
