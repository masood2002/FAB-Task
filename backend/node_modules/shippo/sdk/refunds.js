...
class Refunds extends sdks_js_1.ClientSDK {
    ...
    async create(transaction, async, options) {
        ...
        const payload$ = schemas$.parse(input$, (value$) => components.RefundRequestBody$.outboundSchema.parse(value$), "Input validation failed");
    ...
    async get(refundId, options) {
        ...
        const payload$ = schemas$.parse(input$, (value$) => operations.GetRefundRequest$.outboundSchema.parse(value$), "Input validation failed");
        const body$ = null;
        const pathParams$ = {
